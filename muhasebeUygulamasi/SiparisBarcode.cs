...
{
    public partial class SiparisBarcode : Form
    {
        public SiparisBarcode()
        {
            InitializeComponent();
        }
        ...
        private void SiparisBarcode_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select siparisNo from Siparis_Ekle";
