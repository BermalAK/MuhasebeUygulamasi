...
{
    public partial class FaturaBarcode : Form
    {
        public FaturaBarcode()
        {
            InitializeComponent();
        }
        ...
        private void FaturaBarcode_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select faturaNo from Fatura_Ekle";
