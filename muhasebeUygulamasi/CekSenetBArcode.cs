...
{
    public partial class CekSenetBarcode : Form
    {
        public CekSenetBarcode()
        {
            InitializeComponent();
        }
        ...
        private void CekSenetBarcode_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select portfoyNo from Cek_Senet";
